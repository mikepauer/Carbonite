	...
	if not guidegather then
		guidegather = {
			...
			args = {
              ...
              width = "full",
              name = L["Widowbloom"],
              desc = L["Display"] .. " " .. L["Widowbloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[85]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[85] = not Nx.db.profile.Guide.ShowHerbs[85]
              end,
              },
            deathblossom = {
              order = 88,
              type = "toggle",
              width = "full",
              name = L["Death Blossom"],
              desc = L["Display"] .. " " .. L["Death Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[86]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[86] = not Nx.db.profile.Guide.ShowHerbs[86]
                end,
                 },
            risingglory = {
              order = 89,
              ...
              width = "full",
              name = L["Rising Glory"],
              desc = L["Display"] .. " " .. L["Rising Glory"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[87]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[87] = not Nx.db.profile.Guide.ShowHerbs[87]
                end,
                },
            marrowroot = {
              order = 90,
              ...
              width = "full",
              name = L["Marrowroot"],
              desc = L["Display"] .. " " .. L["Marrowroot"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[88]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[88] = not Nx.db.profile.Guide.ShowHerbs[88]
                end,
                  },
            vigilstorch = {
              order = 91,
              type = "toggle",
              width = "full",
              name = L["Vigil's Torch"],
              desc = L["Display"] .. " " .. L["Vigil's Torch"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[89]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[89] = not Nx.db.profile.Guide.ShowHerbs[89]
                end,
                },
            nightshade = {
              order = 92,
              ...
              width = "full",
              name = L["Nightshade"],
              desc = L["Display"] .. " " .. L["Nightshade"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[90]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[90] = not Nx.db.profile.Guide.ShowHerbs[90]
              end,
              },
            hochenblume = {
              order = 93,
              ...
              width = "full",
              name = L["Hochenblume"],
              desc = L["Display"] .. " " .. L["Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[91]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[91] = not Nx.db.profile.Guide.ShowHerbs[91]
              end,
            },
            decayedhochenblume = {
              order = 94,
              type = "toggle",
              width = "full",
              name = L["Decayed Hochenblume"],
              desc = L["Display"] .. " " .. L["Decayed Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[92]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[92] = not Nx.db.profile.Guide.ShowHerbs[92]
              end,
            },
            frigidhochenblume = {
              order = 95,
              type = "toggle",
              width = "full",
              name = L["Frigid Hochenblume"],
              desc = L["Display"] .. " " .. L["Frigid Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[93]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[93] = not Nx.db.profile.Guide.ShowHerbs[93]
              end,
            },
            infurioushochenblume = {
              order = 96,
              type = "toggle",
              width = "full",
              name = L["Infurious Hochenblume"],
              desc = L["Display"] .. " " .. L["Infurious Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[94]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[94] = not Nx.db.profile.Guide.ShowHerbs[94]
              end,
            },
            lushochenblume = {
              order = 97,
              type = "toggle",
              width = "full",
              name = L["Lush Hochenblume"],
              desc = L["Display"] .. " " .. L["Lush Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[95]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[95] = not Nx.db.profile.Guide.ShowHerbs[95]
              end,
            },
            titanhochenblume = {
              order = 98,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Hochenblume"],
              desc = L["Display"] .. " " .. L["Titan-Touched Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[96]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[96] = not Nx.db.profile.Guide.ShowHerbs[96]
              end,
              },
            windhochenblume = {
              order = 99,
              type = "toggle",
              width = "full",
              name = L["Windswept Hochenblume"],
              desc = L["Display"] .. " " .. L["Windswept Hochenblume"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[97]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[97] = not Nx.db.profile.Guide.ShowHerbs[97]
              end,
               },
            bubblepoppy = {
              order = 100,
              ...
              width = "full",
              name = L["Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[98]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[98] = not Nx.db.profile.Guide.ShowHerbs[98]
              end,
              },
            decayedbubblepoppy = {
              order = 101,
              type = "toggle",
              width = "full",
              name = L["Decayed Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Decayed Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[99]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[99] = not Nx.db.profile.Guide.ShowHerbs[99]
              end,
              },
            fribubblepoppy = {
              order = 102,
              type = "toggle",
              width = "full",
              name = L["Frigid Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Frigid Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[100]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[100] = not Nx.db.profile.Guide.ShowHerbs[100]
              end,
              },
            infububblepoppy = {
              order = 103,
              type = "toggle",
              width = "full",
              name = L["Infurious Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Infurious Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[101]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[101] = not Nx.db.profile.Guide.ShowHerbs[101]
              end,
              },
            lushbubblepoppy = {
              order = 104,
              type = "toggle",
              width = "full",
              name = L["Lush Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Lush Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[102]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[102] = not Nx.db.profile.Guide.ShowHerbs[102]
              end,
              },
            titanbubblepoppy = {
              order = 105,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Titan-Touched Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[103]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[103] = not Nx.db.profile.Guide.ShowHerbs[103]
              end,
              },
            windbubblepoppy = {
              order = 106,
              type = "toggle",
              width = "full",
              name = L["Windswept Bubble Poppy"],
              desc = L["Display"] .. " " .. L["Windswept Bubble Poppy"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[104]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[104] = not Nx.db.profile.Guide.ShowHerbs[104]
              end,
              },
            saxifrage = {
              order = 107,
              ...
              width = "full",
              name = L["Saxifrage"],
              desc = L["Display"] .. " " .. L["Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[105]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[105] = not Nx.db.profile.Guide.ShowHerbs[105]
              end,
              },
            decayedsaxifrage = {
              order = 108,
              type = "toggle",
              width = "full",
              name = L["Decayed Saxifrage"],
              desc = L["Display"] .. " " .. L["Decayed Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[106]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[106] = not Nx.db.profile.Guide.ShowHerbs[106]
              end,
              },
            frisaxifrage = {
              order = 109,
              type = "toggle",
              width = "full",
              name = L["Frigid Saxifrage"],
              desc = L["Display"] .. " " .. L["Frigid Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[107]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[107] = not Nx.db.profile.Guide.ShowHerbs[107]
              end,
              },
            infusaxifrage = {
              order = 110,
              type = "toggle",
              width = "full",
              name = L["Infurious Saxifrage"],
              desc = L["Display"] .. " " .. L["Infurious Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[108]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[108] = not Nx.db.profile.Guide.ShowHerbs[108]
              end,
              },
            lushsaxifrage = {
              order = 111,
              type = "toggle",
              width = "full",
              name = L["Lush Saxifrage"],
              desc = L["Display"] .. " " .. L["Lush Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[109]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[109] = not Nx.db.profile.Guide.ShowHerbs[109]
              end,
              },
            titansaxifrage = {
              order = 112,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Saxifrage"],
              desc = L["Display"] .. " " .. L["Titan-Touched Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[110]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[110] = not Nx.db.profile.Guide.ShowHerbs[110]
              end,
              },
            windsaxifrage = {
              order = 113,
              type = "toggle",
              width = "full",
              name = L["Windswept Saxifrage"],
              desc = L["Display"] .. " " .. L["Windswept Saxifrage"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[111]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[111] = not Nx.db.profile.Guide.ShowHerbs[111]
              end,
              },
            writhebark = {
              order = 114,
              ...
              width = "full",
              name = L["Writhebark"],
              desc = L["Display"] .. " " .. L["Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[112]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[112] = not Nx.db.profile.Guide.ShowHerbs[112]
              end,
              },
              decayedwrithebark = {
              order = 115,
              type = "toggle",
              width = "full",
              name = L["Decayed Writhebark"],
              desc = L["Display"] .. " " .. L["Decayed Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[113]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[113] = not Nx.db.profile.Guide.ShowHerbs[113]
              end,
              },
            friwrithebark = {
              order = 116,
              type = "toggle",
              width = "full",
              name = L["Frigid Writhebark"],
              desc = L["Display"] .. " " .. L["Frigid Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[114]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[114] = not Nx.db.profile.Guide.ShowHerbs[114]
              end,
              },
            infuwrithebark = {
              order = 117,
              type = "toggle",
              width = "full",
              name = L["Infurious Writhebark"],
              desc = L["Display"] .. " " .. L["Infurious Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[115]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[115] = not Nx.db.profile.Guide.ShowHerbs[115]
              end,
              },
            lushwrithebark = {
              order = 118,
              type = "toggle",
              width = "full",
              name = L["Lush Writhebark"],
              desc = L["Display"] .. " " .. L["Lush Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[116]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[116] = not Nx.db.profile.Guide.ShowHerbs[116]
              end,
              },
            titanwrithebark = {
              order = 119,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Writhebark"],
              desc = L["Display"] .. " " .. L["Titan-Touched Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[117]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[117] = not Nx.db.profile.Guide.ShowHerbs[117]
              end,
              },
            windwrithebark = {
              order = 120,
              type = "toggle",
              width = "full",
              name = L["Windswept Writhebark"],
              desc = L["Display"] .. " " .. L["Windswept Writhebark"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[118]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[118] = not Nx.db.profile.Guide.ShowHerbs[118]
              end,
              },
	     mycobloom = {
              order = 121,
              ...
              width = "full",
              name = L["Mycobloom"],
              desc = L["Display"] .. " " .. L["Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[119]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[119] = not Nx.db.profile.Guide.ShowHerbs[119]
              end,
            },
           altermycobloom = {
              order = 122,
              type = "toggle",
              width = "full",
              name = L["Altered Mycobloom"],
              desc = L["Display"] .. " " .. L["Altered Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[120]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[120] = not Nx.db.profile.Guide.ShowHerbs[120]
              end,
            },
            crystalmycobloom = {
              order = 123,
              type = "toggle",
              width = "full",
              name = L["Crystallized Mycobloom"],
              desc = L["Display"] .. " " .. L["Crystallized Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[121]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[121] = not Nx.db.profile.Guide.ShowHerbs[121]
              end,
            },
            irradimycobloom = {
              order = 124,
              type = "toggle",
              width = "full",
              name = L["Irradiated Mycobloom"],
              desc = L["Display"] .. " " .. L["Irradiated Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[122]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[122] = not Nx.db.profile.Guide.ShowHerbs[122]
              end,
            },
            lushmycobloom = {
              order = 125,
              type = "toggle",
              width = "full",
              name = L["Lush Mycobloom"],
              desc = L["Display"] .. " " .. L["Lush Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[123]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[123] = not Nx.db.profile.Guide.ShowHerbs[123]
              end,
            },
            sporemycobloom = {
              order = 126,
              type = "toggle",
              width = "full",
              name = L["Sporefused Mycobloom"],
              desc = L["Display"] .. " " .. L["Sporefused Mycobloom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[124]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[124] = not Nx.db.profile.Guide.ShowHerbs[124]
              end,
            },
            luredrop = {
              order = 127,
              ...
              width = "full",
              name = L["Luredrop"],
              desc = L["Display"] .. " " .. L["Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[125]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[125] = not Nx.db.profile.Guide.ShowHerbs[125]
              end,
            },
           alterluredrop = {
              order = 128,
              type = "toggle",
              width = "full",
              name = L["Altered Luredrop"],
              desc = L["Display"] .. " " .. L["Altered Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[126]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[126] = not Nx.db.profile.Guide.ShowHerbs[126]
              end,
            },
            crystaluredrop = {
              order = 129,
              type = "toggle",
              width = "full",
              name = L["Crystallized Luredrop"],
              desc = L["Display"] .. " " .. L["Crystallized Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[127]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[127] = not Nx.db.profile.Guide.ShowHerbs[127]
              end,
            },
            irradiluredrop = {
              order = 130,
              type = "toggle",
              width = "full",
              name = L["Irradiated Luredrop"],
              desc = L["Display"] .. " " .. L["Irradiated Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[128]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[128] = not Nx.db.profile.Guide.ShowHerbs[128]
              end,
            },
            lushluredrop = {
              order = 131,
              type = "toggle",
              width = "full",
              name = L["Lush Luredrop"],
              desc = L["Display"] .. " " .. L["Lush Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[129]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[129] = not Nx.db.profile.Guide.ShowHerbs[129]
              end,
            },
            sporeluredrop = {
              order = 132,
              type = "toggle",
              width = "full",
              name = L["Sporefused Luredrop"],
              desc = L["Display"] .. " " .. L["Sporefused Luredrop"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[130]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[130] = not Nx.db.profile.Guide.ShowHerbs[130]
              end,
            },
            orbinid = {
              order = 133,
              ...
              width = "full",
              name = L["Orbinid"],
              desc = L["Display"] .. " " .. L["Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[131]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[131] = not Nx.db.profile.Guide.ShowHerbs[131]
              end,
            },
           alterorbinid = {
              order = 134,
              type = "toggle",
              width = "full",
              name = L["Altered Orbinid"],
              desc = L["Display"] .. " " .. L["Altered Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[132]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[132] = not Nx.db.profile.Guide.ShowHerbs[132]
              end,
            },
            crystaorbinid = {
              order = 135,
              type = "toggle",
              width = "full",
              name = L["Crystallized Orbinid"],
              desc = L["Display"] .. " " .. L["Crystallized Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[133]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[133] = not Nx.db.profile.Guide.ShowHerbs[133]
              end,
            },
            irradiorbinid = {
              order = 136,
              type = "toggle",
              width = "full",
              name = L["Irradiated Orbinid"],
              desc = L["Display"] .. " " .. L["Irradiated Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[134]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[134] = not Nx.db.profile.Guide.ShowHerbs[134]
              end,
            },
            lushorbinid = {
              order = 137,
              ...
              width = "full",
              name = L["Lush Orbinid"],
              desc = L["Display"] .. " " .. L["Lush Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[135]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[135] = not Nx.db.profile.Guide.ShowHerbs[135]
              end,
            },
            sporeorbinid = {
              order = 138,
              type = "toggle",
              width = "full",
              name = L["Sporefused Orbinid"],
              desc = L["Display"] .. " " .. L["Sporefused Orbinid"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[136]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[136] = not Nx.db.profile.Guide.ShowHerbs[136]
              end,
            },
            arathorspear = {
              order = 139,
              type = "toggle",
              width = "full",
              name = L["Arathor's Spear"],
              desc = L["Display"] .. " " .. L["Arathor's Spear"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[137]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[137] = not Nx.db.profile.Guide.ShowHerbs[137]
              end,
            },
            crystaarathorspear = {
              order = 140,
              type = "toggle",
              width = "full",
              name = L["Crystallized Arathor's Spear"],
              desc = L["Display"] .. " " .. L["Crystallized Arathor's Spear"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[138]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[138] = not Nx.db.profile.Guide.ShowHerbs[138]
              end,
            },
            irradiarathorspear = {
              order = 141,
              type = "toggle",
              width = "full",
              name = L["Irradiated Arathor's Spear"],
              desc = L["Display"] .. " " .. L["Irradiated Arathor's Spear"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[139]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[139] = not Nx.db.profile.Guide.ShowHerbs[139]
              end,
            },
            lusharathorspear = {
              order = 142,
              type = "toggle",
              width = "full",
              name = L["Lush Arathor's Spear"],
              desc = L["Display"] .. " " .. L["Lush Arathor's Spear"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[140]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[140] = not Nx.db.profile.Guide.ShowHerbs[140]
              end,
            },
            sporearathorspear = {
              order = 143,
              type = "toggle",
              width = "full",
              name = L["Sporefused Arathor's Spear"],
              desc = L["Display"] .. " " .. L["Sporefused Arathor's Spear"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[141]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[141] = not Nx.db.profile.Guide.ShowHerbs[141]
              end,
            },
            blessingblossom = {
              order = 144,
              type = "toggle",
              width = "full",
              name = L["Blessing Blossom"],
              desc = L["Display"] .. " " .. L["Blessing Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[142]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[142] = not Nx.db.profile.Guide.ShowHerbs[142]
              end,
            },
            crystablessingblossom = {
              order = 145,
              type = "toggle",
              width = "full",
              name = L["Crystallized Blessing Blossom"],
              desc = L["Display"] .. " " .. L["Crystallized Blessing Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[143]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[143] = not Nx.db.profile.Guide.ShowHerbs[143]
              end,
            },
            irradiblessingblossom = {
              order = 146,
              type = "toggle",
              width = "full",
              name = L["Irradiated Blessing Blossom"],
              desc = L["Display"] .. " " .. L["Irradiated Blessing Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[144]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[144] = not Nx.db.profile.Guide.ShowHerbs[144]
              end,
            },
            lushblessingblossom = {
              order = 147,
              type = "toggle",
              width = "full",
              name = L["Lush Blessing Blossom"],
              desc = L["Display"] .. " " .. L["Lush Blessing Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[145]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[145] = not Nx.db.profile.Guide.ShowHerbs[145]
              end,
            },
            sporeblessingblossom = {
              order = 148,
              type = "toggle",
              width = "full",
              name = L["Sporefused Blessing Blossom"],
              desc = L["Display"] .. " " .. L["Sporefused Blessing Blossom"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowHerbs[146]
              end,
              set = function()
                Nx.db.profile.Guide.ShowHerbs[146] = not Nx.db.profile.Guide.ShowHerbs[146]
              end,
            },				
					},
				},
            ...
            laestrite = {
              ...
              type = "toggle",
              width = "full",
              name = L["Laestrite Ore"],
              desc = L["Display"] .. " " .. L["Laestrite Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[61]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[61] = not Nx.db.profile.Guide.ShowMines[61]
              end,
              },
              laestriterich = {
              order = 64,
              type = "toggle",
              width = "full",
              name = L["Rich Laestrite Ore"],
              desc = L["Display"] .. " " .. L["Rich Laestrite Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[62]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[62] = not Nx.db.profile.Guide.ShowMines[62]
              end,
              },
            elethium = {
              order = 65,
              ...
              width = "full",
              name = L["Elethium Ore"],
              desc = L["Display"] .. " " .. L["Elethium Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[63]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[63] = not Nx.db.profile.Guide.ShowMines[63]
              end,
              },
              elethiumrich = {
              order = 66,
              type = "toggle",
              width = "full",
              name = L["Rich Elethium Ore"],
              desc = L["Display"] .. " " .. L["Rich Elethium Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[64]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[64] = not Nx.db.profile.Guide.ShowMines[64]
              end,
              },
            solenium = {
              order = 67,
              ...
              width = "full",
              name = L["Solenium Ore"],
              desc = L["Display"] .. " " .. L["Solenium Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[65]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[65] = not Nx.db.profile.Guide.ShowMines[65]
              end,
               },
               soleniumrich = {
              order = 68,
              type = "toggle",
              width = "full",
              name = L["Rich Solenium Ore"],
              desc = L["Display"] .. " " .. L["Rich Solenium Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[66]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[66] = not Nx.db.profile.Guide.ShowMines[66]
              end,
               },
            oxxein = {
              order = 69,
              ...
              width = "full",
              name = L["Oxxein Ore"],
              desc = L["Display"] .. " " .. L["Oxxein Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[67]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[67] = not Nx.db.profile.Guide.ShowMines[67]
              end,
                 },
                 oxxeinrich = {
              order = 70,
              type = "toggle",
              width = "full",
              name = L["Rich Oxxein Ore"],
              desc = L["Display"] .. " " .. L["Rich Oxxein Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[68]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[68] = not Nx.db.profile.Guide.ShowMines[68]
              end,
                 },
            phaedrite = {
              order = 71,
              ...
              width = "full",
              name = L["Phaedrum Ore"],
              desc = L["Display"] .. " " .. L["Phaedrum Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[69]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[69] = not Nx.db.profile.Guide.ShowMines[69]
              end,
               },
               phaedriterich = {
              order = 72,
              type = "toggle",
              width = "full",
              name = L["Rich Phaedrum Ore"],
              desc = L["Display"] .. " " .. L["Rich Phaedrum Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[70]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[70] = not Nx.db.profile.Guide.ShowMines[70]
              end,
               },
            sinvyr = {
              order = 73,
              ...
              width = "full",
              name = L["Sinvyr Ore"],
              desc = L["Display"] .. " " .. L["Sinvyr Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[71]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[71] = not Nx.db.profile.Guide.ShowMines[71]
              end,
               },
            sinvyrrich = {
              order = 74,
              type = "toggle",
              width = "full",
              name = L["Rich Sinvyr Ore"],
              desc = L["Display"] .. " " .. L["Rich Sinvyr Ore"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[72]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[72] = not Nx.db.profile.Guide.ShowMines[72]
              end,
              },
            serevite = {
              order = 75,
              type = "toggle",
              width = "full",
              name = L["Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[73]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[73] = not Nx.db.profile.Guide.ShowMines[73]
              end,
              },
            hardserevite = {
              order = 76,
              type = "toggle",
              width = "full",
              name = L["Hardened Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Hardened Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[74]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[74] = not Nx.db.profile.Guide.ShowMines[74]
              end,
              },
            infuserevite = {
              order = 77,
              type = "toggle",
              width = "full",
              name = L["Infurious Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Infurious Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[75]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[75] = not Nx.db.profile.Guide.ShowMines[75]
              end,
              },
            moltserevite = {
              order = 78,
              type = "toggle",
              width = "full",
              name = L["Molten Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Molten Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[76]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[76] = not Nx.db.profile.Guide.ShowMines[76]
              end,
              },
            primserevite = {
              order = 79,
              type = "toggle",
              width = "full",
              name = L["Primal Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Primal Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[77]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[77] = not Nx.db.profile.Guide.ShowMines[77]
              end,
              },
            richserevite = {
              order = 80,
              type = "toggle",
              width = "full",
              name = L["Rich Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Rich Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[78]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[78] = not Nx.db.profile.Guide.ShowMines[78]
              end,
              },
            titanserevite = {
              order = 81,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Serevite Deposit"],
              desc = L["Display"] .. " " .. L["Titan-Touched Serevite Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[79]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[79] = not Nx.db.profile.Guide.ShowMines[79]
              end,
						},
            draconium = {
              order = 82,
              type = "toggle",
              width = "full",
              name = L["Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[80]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[80] = not Nx.db.profile.Guide.ShowMines[80]
              end,
              },
            harddraconium = {
              order = 83,
              type = "toggle",
              width = "full",
              name = L["Hardened Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Hardened Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[81]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[81] = not Nx.db.profile.Guide.ShowMines[81]
              end,
              },
            infudraconium = {
              order = 84,
              type = "toggle",
              width = "full",
              name = L["Infurious Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Infurious Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[82]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[82] = not Nx.db.profile.Guide.ShowMines[82]
              end,
              },
            moltdraconium = {
              order = 85,
              type = "toggle",
              width = "full",
              name = L["Molten Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Molten Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[83]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[83] = not Nx.db.profile.Guide.ShowMines[83]
              end,
              },
            primdraconium = {
              order = 86,
              type = "toggle",
              width = "full",
              name = L["Primal Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Primal Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[84]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[84] = not Nx.db.profile.Guide.ShowMines[84]
              end,
              },
            richdraconium = {
              order = 87,
              type = "toggle",
              width = "full",
              name = L["Rich Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Rich Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[85]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[85] = not Nx.db.profile.Guide.ShowMines[85]
              end,
              },
            titandraconium = {
              order = 88,
              type = "toggle",
              width = "full",
              name = L["Titan-Touched Draconium Deposit"],
              desc = L["Display"] .. " " .. L["Titan-Touched Draconium Deposit"] .. " " .. L["Nodes On Map"],
              get = function()
                return Nx.db.profile.Guide.ShowMines[86]
              end,
              set = function()
                Nx.db.profile.Guide.ShowMines[86] = not Nx.db.profile.Guide.ShowMines[86]
              end,
		},
bismuth = {
    order = 89,
    type = "toggle",
    width = "full",
    name = L["Bismuth Deposit"],
    desc = L["Display"] .. " " .. L["Bismuth Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[87]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[87] = not Nx.db.profile.Guide.ShowMines[87]
    end,
},
crystallizedbismuth = {
    order = 90,
    type = "toggle",
    width = "full",
    name = L["Crystallized Bismuth Deposit"],
    desc = L["Display"] .. " " .. L["Crystallized Bismuth Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[88]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[88] = not Nx.db.profile.Guide.ShowMines[88]
    end,
},
ezminebismuth = {
    order = 91,
    type = "toggle",
    width = "full",
    name = L["EZ-Mine Bismuth Deposit"],
    desc = L["Display"] .. " " .. L["EZ-Mine Bismuth Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[89]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[89] = not Nx.db.profile.Guide.ShowMines[89]
    end,
},
richbismuth = {
    order = 92,
    type = "toggle",
    width = "full",
    name = L["Rich Bismuth Deposit"],
    desc = L["Display"] .. " " .. L["Rich Bismuth Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[90]
    end,
    set = function()
...
webbedore = {
    ...
    set = function()
        Nx.db.profile.Guide.ShowMines[91] = not Nx.db.profile.Guide.ShowMines[91]
    end,
},
weepingbismuth = {
    order = 94,
    type = "toggle",
    width = "full",
    name = L["Weeping Bismuth Deposit"],
    desc = L["Display"] .. " " .. L["Weeping Bismuth Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[92]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[92] = not Nx.db.profile.Guide.ShowMines[92]
    end,
},
ironclaw = {
    order = 95,
    type = "toggle",
    width = "full",
    name = L["Ironclaw Deposit"],
    desc = L["Display"] .. " " .. L["Ironclaw Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[93]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[93] = not Nx.db.profile.Guide.ShowMines[93]
    end,
},
crystallizedironclaw = {
    order = 96,
    type = "toggle",
    width = "full",
    name = L["Crystallized Ironclaw Deposit"],
    desc = L["Display"] .. " " .. L["Crystallized Ironclaw Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[94]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[94] = not Nx.db.profile.Guide.ShowMines[94]
    end,
},
ezmineironclaw = {
    order = 97,
    type = "toggle",
    width = "full",
    name = L["EZ-Mine Ironclaw Deposit"],
    desc = L["Display"] .. " " .. L["EZ-Mine Ironclaw Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[95]
    end,
    set = function()
        Nx.db.profile.Guide.ShowMines[95] = not Nx.db.profile.Guide.ShowMines[95]
    end,
},
richironclaw = {
    order = 98,
    type = "toggle",
    width = "full",
    name = L["Rich Ironclaw Deposit"],
    desc = L["Display"] .. " " .. L["Rich Ironclaw Deposit"] .. " " .. L["Nodes On Map"],
    get = function()
        return Nx.db.profile.Guide.ShowMines[96]
    end,
    set = function()
