...
---------------------------------------------------------------------------------------
-- Commit: 2020-11-30 10:42:32 +0100 (6377da4)
---------------------------------------------------------------------------------------
local _G = getfenv(0)
...
Nx.GatherInfo = {
	...
	["H"] = {	-- Herbs
		{ 1,	"inv_misc_herb_ancientlichen",L["Ancient Lichen"]},
		{ 1,	"inv_misc_herb_13",L["Arthas' Tears"]},
		{ 1,	"inv_misc_herb_17",L["Black Lotus"]},
		{ 1,	"inv_misc_herb_14",L["Blindweed"]},
		{ 1,	"inv_misc_herb_11a",L["Bloodthistle"]},
		{ 1,	"inv_misc_root_01",L["Briarthorn"]},
		{ 1,	"inv_misc_herb_01",L["Bruiseweed"]},
		{ 1,	"inv_misc_herb_dreamfoil",L["Dreamfoil"]},
		{ 1,	"inv_misc_herb_dreamingglory",L["Dreaming Glory"]},
		{ 1,	"inv_misc_herb_07",L["Earthroot"]},
		{ 1,	"inv_misc_herb_12",L["Fadeleaf"]},
		{ 1,	"inv_misc_herb_felweed",L["Felweed"]},
		{ 1,	"inv_misc_herb_19",L["Firebloom"]},
		{ 1,	"inv_misc_herb_flamecap",L["Flame Cap"]},
		{ 1,	"inv_mushroom_08",L["Ghost Mushroom"]},
		{ 1,	"inv_misc_herb_sansamroot",L["Golden Sansam"]},
		{ 1,	"inv_misc_herb_15",L["Goldthorn"]},
		{ 1,	"inv_misc_dust_02",L["Grave Moss"]},
		{ 1,	"inv_misc_herb_16",L["Gromsblood"]},
		{ 1,	"inv_misc_herb_iceCap",L["Icecap"]},
		{ 1,	"inv_misc_herb_08",L["Khadgar's Whisker"]},
		{ 1,	"inv_misc_herb_03",L["Kingsblood"]},
		{ 1,	"inv_misc_root_02",L["Liferoot"]},
		{ 1,	"spell_shadow_seathanddecay",L["Mageroyal"]},
		{ 1,	"inv_misc_herb_manathistle",L["Mana Thistle"]},
		{ 1,	"inv_misc_herb_mountainsilversage",L["Mountain Silversage"]},
		{ 1,	"inv_misc_herb_netherbloom",L["Netherbloom"]},
		{ 1,	"inv_enchant_dustsoul",L["Netherdust Bush"]},
		{ 1,	"inv_misc_herb_nightmarevine",L["Nightmare Vine"]},
		{ 1,	"inv_misc_flower_02",L["Peacebloom"]},
		{ 1,	"inv_misc_herb_plaguebloom",L["Sorrowmoss"]},
		{ 1,	"inv_misc_herb_17",L["Purple Lotus"]},
		{ 1,	"inv_misc_herb_ragveil",L["Ragveil"]},
		{ 1,	"inv_misc_herb_10",L["Silverleaf"]},
		{ 1,	"inv_misc_herb_11",L["Stranglekelp"]},
		{ 1,	"inv_misc_herb_18",L["Sungrass"]},
		{ 1,	"inv_misc_herb_terrocone",L["Terocone"]},	-- Someone should check if inv_misc_herb_Terrocone needs to be changed to Terocone (http://www.wowhead.com/item=22789)
		{ 1,	"inv_misc_flower_01",L["Wild Steelbloom"]},
		{ 1,	"inv_misc_flower_03",L["Dragon's Teeth"]},
		{ 1,	"inv_mushroom_02",L["Glowcap"]},
		{ 1,	"inv_misc_herb_goldclover",L["Goldclover"]},
		{ 1,	"inv_misc_herb_talandrasrose",L["Talandra's Rose"]},
		{ 1,	"inv_misc_herb_evergreenmoss",L["Adder's Tongue"]},
		{ 1,	"inv_misc_herb_goldclover",L["Frozen Herb"]},
		{ 1,	"inv_misc_herb_tigerlily",L["Tiger Lily"]},
		{ 1,	"inv_misc_herb_whispervine",L["Lichbloom"]},
		{ 1,	"inv_misc_herb_icethorn",L["Icethorn"]},
		{ 1,	"inv_misc_herb_frostlotus",L["Frost Lotus"]},
		{ 1,	"inv_misc_herb_11a",L["Firethorn"]},
		{ 1,	"inv_misc_herb_azsharasveil",L["Azshara's Veil"]},
		{ 1,	"inv_misc_herb_cinderbloom",L["Cinderbloom"]},
		{ 1,	"inv_misc_herb_stormvine",L["Stormvine"]},
		{ 1,	"inv_misc_herb_heartblossom",L["Heartblossom"]},
		{ 1,	"inv_misc_herb_whiptail",L["Whiptail"]},
		{ 1,	"inv_misc_herb_twilightjasmine",L["Twilight Jasmine"]},
		{ 1,	"inv_misc_herb_foolscap",L["Fool's Cap"]},
		{ 1,	"inv_misc_herb_goldenlotus",L["Golden Lotus"]},
		{ 1,	"inv_misc_herb_jadetealeaf",L["Green Tea Leaf"]},
		{ 1,	"inv_misc_herb_rainpoppy",L["Rain Poppy"]},
		{ 1,	"inv_misc_herb_shaherb",L["Sha-Touched Herb"]},
		{ 1,	"inv_misc_herb_silkweed",L["Silkweed"]},
		{ 1,	"inv_misc_herb_snowlily",L["Snow Lily"]},
		{ 1,	"inv_misc_herb_chamlotus",L["Chameleon Lotus"]},
		{ 1,	"inv_misc_herb_frostweed",L["Frostweed"]},
		{ 1,	"inv_misc_herb_flytrap",L["Gorgrond Flytrap"]},
		{ 1,	"inv_misc_herb_starflower",L["Starflower"]},
		{ 1,	"inv_misc_herb_arrowbloom",L["Nagrand Arrowbloom"]},
		{ 1,	"inv_misc_herb_taladororchid",L["Talador Orchid"]},
		{ 1,	"inv_misc_herb_fireweed",L["Fireweed"]},
		{ 1,	"inv_farm_pumpkinseed_yellow",L["Withered Herb"]},
		{ 1,	"inv_herbalism_70_aethril",L["Aethril"]},
		{ 1,	"inv_herbalism_70_dreamleaf",L["Dreamleaf"]},
		{ 1,	"inv_herbalism_70_felwort",L["Felwort"]},
		{ 1,	"inv_herbalism_70_fjarnskaggl",L["Fjarnskaggl"]},
		{ 1,	"inv_herbalism_70_foxflower",L["Foxflower"]},
		{ 1,	"inv_herbalism_70_starlightrosepetals",L["Starlight Rose"]},
		{ 1,  "inv_misc_herb_astralglory",L["Astral Glory"]},
		-- BfA
		{ 1,  "inv_misc_herb_akundasbite",L["Akunda's Bite"]},
		{ 1,  "inv_misc_herb_anchorweed",L["Anchor Weed"]},
		{ 1,  "inv_misc_herb_riverbud",L["Riverbud"]},
		{ 1,  "inv_misc_herb_seastalk",L["Sea Stalks"]},
		{ 1,  "inv_misc_herb_pollen",L["Siren's Sting"]},
		{ 1,  "inv_misc_herb_starmoss",L["Star Moss"]},
		{ 1,  "inv_misc_herb_winterskiss",L["Winter's Kiss"]},
		{ 1,  "inv_misc_herb_bloodcup",L["Widowbloom"]},
		{ 1,  "inv_ misc_herb_deathblossom",L["Death Blossom"]},
		{ 1,  "inv_misc_herb_risingglory",L["Rising Glory"]},
	...
	["M"] = {	-- Mine node
		...
		{ 1,	"inv_misc_gem_01",L["Ancient Gem Vein"]},
		{ 1,	"inv_ore_copper_01",L["Copper Vein"]},
		{ 1,	"inv_ore_mithril_01",L["Dark Iron Deposit"]},
		{ 1,	"inv_ore_feliron",L["Fel Iron Deposit"]},
		{ 1,	"inv_ore_copper_01",L["Gold Vein"]},
		{ 1,	"inv_ore_thorium_01",L["Incendicite Mineral Vein"]},
		{ 1,	"inv_ore_mithril_01",L["Indurium Mineral Vein"]},
		{ 1,	"inv_ore_iron_01",L["Iron Deposit"]},
		{ 1,	"inv_ore_khorium",L["Khorium Vein"]},
		{ 1,	"inv_stone_15",L["Large Obsidian Chunk"]},
		{ 1,	"inv_ore_thorium_01",L["Lesser Bloodstone Deposit"]},
		{ 1,	"inv_ore_mithril_02",L["Mithril Deposit"]},
		{ 1,	"inv_ore_ethernium_01",L["Nethercite Deposit"]},
		{ 1,	"inv_ore_adamantium",L["Rich Adamantite Deposit"]},
		{ 1,	"inv_ore_thorium_02",L["Rich Thorium Vein"]},
		{ 1,	"inv_stone_16",L["Silver Vein"]},
		{ 1,	"inv_misc_stonetablet_01",L["Small Obsidian Chunk"]},
		{ 1,	"inv_ore_thorium_02",L["Small Thorium Vein"]},
		{ 1,	"inv_ore_tin_01",L["Tin Vein"]},
		{ 1,	"inv_ore_truesilver_01",L["Truesilver Deposit"]},
		{ 1,	"inv_ore_cobalt",L["Cobalt Deposit"]},
		{ 1,	"inv_ore_cobalt",L["Rich Cobalt Deposit"]},
		{ 1,	"inv_ore_saronite_01",L["Saronite Deposit"]},
		{ 1,	"inv_ore_saronite_01",L["Rich Saronite Deposit"]},
		{ 1,	"inv_ore_platinum_01",L["Titanium Vein"]},
		{ 1,	"item_elementiumore",L["Obsidium Deposit"]},
		{ 1,	"item_elementiumore",L["Rich Obsidium Deposit"]},
		{ 1,	"item_pyriumore",L["Elementium Vein"]},
		{ 1,	"item_pyriumore",L["Rich Elementium Vein"]},
		{ 1,	"inv_ore_arcanite_01",L["Pyrite Deposit"]},
		{ 1,	"inv_ore_arcanite_01",L["Rich Pyrite Deposit"]},
		{ 1,	"inv_ore_ghostiron",L["Ghost Iron Deposit"]},
		{ 1,	"inv_ore_ghostiron",L["Rich Ghost Iron Deposit"]},
		{ 1,	"inv_ore_manticyte",L["Kyparite Deposit"]},
		{ 1,	"inv_ore_manticyte",L["Rich Kyparite Deposit"]},
		{ 1,	"inv_ore_trilliumwhite",L["Trillium Vein"]},
		{ 1,	"inv_ore_trilliumWhite",L["Rich Trillium Vein"]},
		{ 1,	"inv_ore_trueironore",L["Rich True Iron Deposit"]},
		{ 1,	"inv_ore_trueironore",L["Smoldering True Iron Deposit"]},
		{ 1,	"inv_ore_trueironore",L["True Iron Deposit"]},
		{ 1,	"inv_ore_blackrock_ore",L["Blackrock Deposit"]},
		{ 1,	"inv_ore_blackrock_ore",L["Rich Blackrock Deposit"]},
		{ 1,	"inv_felslate",L["Felslate Deposit"]},
		{ 1,	"inv_felslate",L["Felslate Seam"]},
		{ 1,	"inv_felslate",L["Living Felslate"]},
		{ 1,	"inv_leystone",L["Leystone Deposit"]},
		{ 1,	"inv_leystone",L["Leystone Seam"]},
		{ 1,	"inv_leystone",L["Living Leystone"]},		
		{ 1,  "inv_misc_starmetal",L["Empyrium Deposit"]},
		{ 1,  "inv_misc_starmetal",L["Rich Empyrium Deposit"]},
		{ 1,  "inv_misc_starmetal",L["Empyrium Seam"]},
		-- BfA
		{ 1,  "inv_ore_monalite",L["Monelite Deposit"]},
		{ 1,  "inv_ore_monalite",L["Rich Monelite Deposit"]},
		{ 1,  "inv_ore_monalite",L["Monelite Seam"]},
		{ 1,  "inv_ore_platinum",L["Platinum Deposit"]},
		{ 1,  "inv_ore_platinum",L["Rich Platinum Deposit"]},
		{ 1,  "inv_ore_stormsilver",L["Storm Silver Deposit"]},
		{ 1,  "inv_ore_stormsilver",L["Rich Storm Silver Deposit"]},
		{ 1,  "inv_ore_stormsilver",L["Storm Silver Seam"]},
	--shadowlands
		{ 1,  "inv_ore_lastrite",L["Laestrite Deposit"]},
	  { 1,  "inv_ore_lastrite",L["Rich Laestrite Deposit"]},
		{ 1,  "inv_ore_elethium",L["Elethium Deposit"]},
		{ 1,  "inv_ore_elethium",L["Rich Elethium Deposit"]},
		{ 1,  "inv_ore_solenium",L["Solenium Deposit"]},
		{ 1,  "inv_ore_solenium",L["Rich Solenium Deposit"]},
		{ 1,  "inv_ore_oxxein",L["Oxxein Deposit"]},
		{ 1,  "inv_ore_oxxein",L["Rich Oxxein Deposit"]},
